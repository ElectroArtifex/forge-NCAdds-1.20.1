...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FIREBIRD_ASH = registerBlock("firebird_ash",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.TURTLE_EGG).sound(SoundType.WOOL)));
